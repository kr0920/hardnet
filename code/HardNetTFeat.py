...
parser.add_argument('--log-dir', default='data/logs/tfeat_whole/',
                    help='folder to output log')
parser.add_argument('--model-dir', default='data/models/tfeat_whole/',
                    help='folder to output model checkpoints')
parser.add_argument('--experiment-name', default= 'liberty_train_tfeat_whole/',
