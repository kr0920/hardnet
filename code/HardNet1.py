...
from Losses1 import loss_HardNet, loss_random_sampling, loss_L2Net, global_orthogonal_regularization
...
parser.add_argument('--log-dir', default='data/logs/margin_sift',
                    help='folder to output log')
parser.add_argument('--model-dir', default='data/models/margin_sift',
...
def train(train_loader, model, optimizer, epoch, logger, load_triplets  = False):
    ...
    for batch_idx, data in pbar:
        ...
        if args.batch_reduce == 'L2Net':
            ...
            loss = loss_HardNet(out_a, out_p,out_sift,
                            margin=args.margin,
                            anchor_swap=args.anchorswap,
